    ...
    for i in range(3):#for loop that runs through the rows and columns of the RGB output
        for j in range(3):
            if i % 2 == 0 and j % 2 == 0:#if statement that checks if the pixel is blue
                RGB_B(i,j)
            elif  i % 2 == 0 and j % 2 == 1:#if statement that checks if the pixel is green-blue, meaning that it's a green pixel followed by a blue pixel
                RGB_GB(i,j)
            elif i % 2 == 1 and j % 2 == 0:#if statement that checks if the pixel is green-red, meaning that it's a green pixel followed by a red pixel
                RGB_GR(i,j)
            else:
